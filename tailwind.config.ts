...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        "menu-in": "menu-in 500ms cubic-bezier(0.25, 1, 0.5, 1) forwards",
        "fade-in": "fade-in 500ms linear forwards",
        "modal-in":
          "modal-in 600ms cubic-bezier(0.25, 1, 0.5, 1) 200ms forwards",
        "modal-out": "modal-out 400ms cubic-bezier(0.5, 0, 0.75, 0) forwards",
      ...
      width: {
        "filters-column": "230px",
        "building-filters": "460px",
        "building-body": "calc(100vw - 460px)",
        "unit-button": "calc(33.2% - 1px)",
      },
      maxWidth: {
        2.5: "0.625rem",
        3: "0.75rem",
